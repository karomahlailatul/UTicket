              ...
              <li className="nav-item menu-open">
                <ul className="nav nav-treeview">
                  <li className="nav-item">
                    <a href="/adminAirline" className="nav-link ">
                      <i className="far fa-circle nav-icon" />
                      <p>Airline</p>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="/adminAirport" className="nav-link ">
                      <i className="far fa-circle nav-icon" />
                      <p>Airport</p>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="/adminFlight" className="nav-link">
                      <i className="far fa-circle nav-icon" />
                      <p>Flight</p>
                    </a>
                  </li>
                  <li className="nav-item">
                    <a href="/adminBooking" className="nav-link">
                      <i className="far fa-circle nav-icon" />
                      <p>Booking</p>
                    </a>
                  </li>
